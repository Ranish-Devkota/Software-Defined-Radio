...
class FM_DMOD(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "FM_DMOD")
        ...
        self.channel_freq = channel_freq = 101e6
        self.Centre_freq = Centre_freq = 101.2e6
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, (Centre_freq-channel_freq), 1, 0, 0)
...
def main(top_block_cls=FM_DMOD, options=None):
